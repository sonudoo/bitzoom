...
if (isset($_SESSION['username']) && isset($_SESSION['id']) && isset($_SESSION['name']) && isset($_SESSION['dob']) && isset($_SESSION['branch']))
  ...
  <div style=\"background-color:lightgreen;border-radius:5px;border-color:green;border:solid darkgreen;\"><img src=\"pc5eyaGMi.png\" height=15 width=15> <font size=2px color=black face=arial><b><a href=\"download.php?course=" . $course . "&file=" . $fltodl . "\">Click here</a> to download <br />" . $fltodl . ".<br /><br />Wasn't that easy? <a href=http://www.facebook.com/bitmesrazoom target=new>Like us</a> on facebook and spread the word.</b></font></div>
...
<div class=\"row\">
  ...
  <div style=\"background-color:magneta;border-radius:5px;border-color:red;border:solid red;\"><font size=2px color=red face=arial><b>Only logged in users can download the files. <br />Please login <a href=index.php>here</a></b></font></div>
