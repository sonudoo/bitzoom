<?php
/* This is the file which validates the question paper download that the user requests to be initiated. This file is similar to download.php except for having a different folder for question papers. */
session_start();
...
$path = "BitZoomQP/"; //The drive and the folder where your files are present. Inside BitZoom folder, we have the folders by Subject code .
