<?php
/* This file is similar to list.php. It only checks the question paper directory. This is the file which lists the content of directory, for example when user selects a course called FDS having course number CS2001, the contents of directory C:\BitZoom\CS2001\ is listed by this script. Change the folder to the location where your files are stored */
...
if (!is_dir($dir))
    {
    /* If the directory is not found, then the admin has not added any question papers related to the subject so return No file found error */
    exit("<br /><br /><font color=red face=arial size=2px><b><center>No files found related to this course. Please check back later.</center></b></font>");
    }
...
foreach($ffs as $ff)
    ...
    if ($ff != '.' && $ff != '..')
        ...
        echo '</font></td> <td>' . $course . '</td><td><div onclick=downloadqp(\'' . $ff . '\') class="btn btn-primary" style="vertical-align:middle">Download</div></td></tr>';
        }
    }
