...
<div style="margin-left:2%;">BitZoom is created by 2k15 students of CSE, Birla Institute of Technology, Ranchi. It is created primarily for content sharing but in future we may include other stuffs to.<br> So Please stay tuned. <br><br><b>Backend -</b> Sushant Kumar Gupta<br><b>Frontend - </b>Abhishek Kujur, Sushant Kumar Gupta<br><br><b><ul><li> Why I need to sign up?</li></b><br>Very simply we need to track which files are downloaded the most and so we can increase its availability and improve our services. Signing up is a very short process and takes hardly half a minute.<br><br><b><br><li>You can add more FAQs here</li></b><br>Answer would appear here<br><br><b><li>What data are you tracking?</li></b><br>We are only tracking your IP from which the file was uploaded or downloaded.<br> We also track your cookies when you login or signup.<br><br><br><br><br><br></ul></div></font>
                </b>
            </div>
        </div>
        <div class="col-sm-3"></div>
